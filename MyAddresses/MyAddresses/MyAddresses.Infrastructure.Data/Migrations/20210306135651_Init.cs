        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Population = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HouseName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bindings_Streets_StreetId",
                        column: x => x.StreetId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Flats_Bindings_BindingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bindings_StreetId",
                table: "Bindings",
                column: "StreetId");

            migrationBuilder.CreateIndex(
                name: "IX_Flats_BindingId",
                table: "Flats",
                column: "BindingId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_FullName_Login",
                table: "Users",
                columns: new[] { "FullName", "Login" });
        }
